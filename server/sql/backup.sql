...
--
-- Host: localhost    Database: mall_tiny
-- ------------------------------------------------------
...
CREATE TABLE `cms_subject` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb3 COMMENT='专题表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_subject_category` (
  ...
  `sort` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb3 COMMENT='专题分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `cms_subject_product_relation` (
  ...
  `product_id` bigint DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 COMMENT='专题商品关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oms_cart_item` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb3 COMMENT='购物车表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `oms_order_item` (
  ...
  `product_attr` varchar(500) DEFAULT NULL COMMENT '商品销售属性:[{"key":"颜色","value":"颜色"},{"key":"容量","value":"4G"}]',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb3 COMMENT='订单中所包含的商品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_member_price` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=201 DEFAULT CHARSET=utf8mb3 COMMENT='商品会员价格表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_attribute` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8mb3 COMMENT='商品属性参数表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_attribute_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3 COMMENT='产品属性分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_category` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb3 COMMENT='产品分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_full_reduction` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb3 COMMENT='产品满减表(只针对同商品)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_product_ladder` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=68 DEFAULT CHARSET=utf8mb3 COMMENT='产品阶梯价格表(只针对同商品)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pms_sku_stock` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=110 DEFAULT CHARSET=utf8mb3 COMMENT='sku的库存';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sms_coupon` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb3 COMMENT='优惠卷表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sms_flash_promotion_product_relation` (
  ...
  `sort` int DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb3 COMMENT='商品限时购与商品关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_admin` VALUES (3,'admin','$2a$10$7WzlCL3oaDtvSNA3aa2n3OYtvNIsZPzL0f6e65HzFDAjhIImw/7vq','http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg','admin@163.com','System Admin','system admin with full rights','2018-10-08 13:32:47','2019-04-20 12:45:16',1),(16,'productManager','$2a$10$zdCIF2FSyY.S8uh/O2DeJeY/XYIL5olLWuspDH8UBW7YNSN1xaumy',NULL,'pm@163.com','Product Manager',NULL,'2024-05-03 09:17:20',NULL,1);
...
CREATE TABLE `ums_admin_login_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=290 DEFAULT CHARSET=utf8mb3 COMMENT='后台用户登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_admin_login_log` VALUES (285,3,'2020-08-24 14:05:21','0:0:0:0:0:0:0:1',NULL,NULL),(286,10,'2020-08-24 14:05:39','0:0:0:0:0:0:0:1',NULL,NULL),(287,3,'2024-05-03 09:23:27','0:0:0:0:0:0:0:1',NULL,NULL),(288,3,'2024-05-03 09:31:52','0:0:0:0:0:0:0:1',NULL,NULL),(289,3,'2024-05-03 09:35:26','0:0:0:0:0:0:0:1',NULL,NULL);
...
CREATE TABLE `ums_admin_role_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8mb3 COMMENT='后台用户和角色关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_admin_role_relation` VALUES (26,3,5),(27,6,1),(28,7,2),(29,1,5),(30,4,5),(31,8,5),(34,12,6),(38,13,5),(39,10,8),(40,16,1);
...
INSERT INTO `ums_member_level` VALUES (1,'Gold',1000,0,199.00,5,1,1,1,1,1,1,NULL),(2,'Platnum',5000,0,99.00,10,1,1,1,1,1,1,NULL),(3,'Diamond',15000,0,69.00,15,1,1,1,1,1,1,NULL),(4,'Normal',1,1,199.00,20,1,1,1,1,0,0,NULL);
...
INSERT INTO `ums_menu` VALUES (1,0,'2020-02-02 14:50:36','Products',0,0,'pms','product',0),(2,1,'2020-02-02 14:51:50','Product List',1,0,'product','product-list',0),(3,1,'2020-02-02 14:52:44','Add Product',1,0,'addProduct','product-add',0),(4,1,'2020-02-02 14:53:51','Category',1,0,'productCate','product-cate',0),(5,1,'2020-02-02 14:54:51','Attribute',1,0,'productAttr','product-attr',0),(6,1,'2020-02-02 14:56:29','Brand',1,0,'brand','product-brand',0),(7,0,'2020-02-02 16:54:07','Orders',0,0,'oms','order',0),(8,7,'2020-02-02 16:55:18','Order List',1,0,'order','product-list',0),(9,7,'2020-02-02 16:56:46','Order Settings',1,0,'orderSetting','order-setting',0),(10,7,'2020-02-02 16:57:39','Return Request',1,0,'returnApply','order-return',0),(11,7,'2020-02-02 16:59:40','Return Reason',1,0,'returnReason','order-return-reason',0),(12,0,'2020-02-04 16:18:00','Sales',0,0,'sms','sms',0),(13,12,'2020-02-04 16:19:22','Flash Sales',1,0,'flash','sms-flash',0),(14,12,'2020-02-04 16:20:16','Coupons',1,0,'coupon','sms-coupon',0),(16,12,'2020-02-07 16:22:38','Home Brand',1,0,'homeBrand','product-brand',0),(17,12,'2020-02-07 16:23:14','New Product',1,0,'homeNew','sms-new',0),(18,12,'2020-02-07 16:26:38','Hot Brand',1,0,'homeHot','sms-hot',0),(19,12,'2020-02-07 16:28:16','Subject Rec',1,0,'homeSubject','sms-subject',0),(20,12,'2020-02-07 16:28:42','Ads List',1,0,'homeAdvertise','sms-ad',0),(21,0,'2020-02-07 16:29:13','Permissions',0,0,'ums','ums',0),(22,21,'2020-02-07 16:29:51','User List',1,0,'admin','ums-admin',0),(23,21,'2020-02-07 16:30:13','Role List',1,0,'role','ums-role',0),(24,21,'2020-02-07 16:30:53','Menu List',1,0,'menu','ums-menu',0),(25,21,'2020-02-07 16:31:13','Resources List',1,0,'resource','ums-resource',0);
...
INSERT INTO `ums_permission` VALUES (1,0,'Product',NULL,NULL,0,NULL,1,'2018-09-29 16:15:14',0),(2,1,'Product List','pms:product:read',NULL,1,'/pms/product/index',1,'2018-09-29 16:17:01',0),(3,1,'Add Product','pms:product:create',NULL,1,'/pms/product/add',1,'2018-09-29 16:18:51',0),(4,1,'Product Category','pms:productCategory:read',NULL,1,'/pms/productCate/index',1,'2018-09-29 16:23:07',0),(5,1,'Product Attribute','pms:productAttribute:read',NULL,1,'/pms/productAttr/index',1,'2018-09-29 16:24:43',0),(6,1,'Brand','pms:brand:read',NULL,1,'/pms/brand/index',1,'2018-09-29 16:25:45',0),(7,2,'Edit Product','pms:product:update',NULL,2,'/pms/product/updateProduct',1,'2018-09-29 16:34:23',0),(8,2,'Delete Product','pms:product:delete',NULL,2,'/pms/product/delete',1,'2018-09-29 16:38:33',0),(9,4,'Add Product Category','pms:productCategory:create',NULL,2,'/pms/productCate/create',1,'2018-09-29 16:43:23',0),(10,4,'Update Product Category','pms:productCategory:update',NULL,2,'/pms/productCate/update',1,'2018-09-29 16:43:55',0),(11,4,'Delete Product Category','pms:productCategory:delete',NULL,2,'/pms/productAttr/delete',1,'2018-09-29 16:44:38',0),(12,5,'Add Product Attribute','pms:productAttribute:create',NULL,2,'/pms/productAttr/create',1,'2018-09-29 16:45:25',0),(13,5,'Modify Product Attribute','pms:productAttribute:update',NULL,2,'/pms/productAttr/update',1,'2018-09-29 16:48:08',0),(14,5,'Delete Product Attribute','pms:productAttribute:delete',NULL,2,'/pms/productAttr/delete',1,'2018-09-29 16:48:44',0),(15,6,'Add Brand','pms:brand:create',NULL,2,'/pms/brand/add',1,'2018-09-29 16:49:34',0),(16,6,'Update Brand','pms:brand:update',NULL,2,'/pms/brand/update',1,'2018-09-29 16:50:55',0),(17,6,'Delete Brand','pms:brand:delete',NULL,2,'/pms/brand/delete',1,'2018-09-29 16:50:59',0),(18,0,'Home',NULL,NULL,0,NULL,1,'2018-09-29 16:51:57',0);
...
CREATE TABLE `ums_resource_category` (
  ...
  `sort` int DEFAULT NULL COMMENT '排序',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb3 COMMENT='资源分类表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_resource_category` VALUES (1,'2020-02-05 10:21:44','Product Module',0),(2,'2020-02-05 10:22:34','Order Module',0),(3,'2020-02-05 10:22:48','Sales Module',0),(4,'2020-02-05 10:23:04','Permissions Module',0),(5,'2020-02-07 16:34:27','Content Module',0),(6,'2020-02-07 16:35:49','Other Module',0);
...
CREATE TABLE `ums_role` (
  ...
  `sort` int DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb3 COMMENT='后台用户角色表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_role` VALUES (1,'Product Manager','access and modify products page',0,'2020-02-03 16:50:37',1,0),(2,'Order Manager','access and modify orders',0,'2018-09-30 15:53:45',1,0),(5,'Super Admin','full admin rights',0,'2020-02-02 15:11:05',1,0),(8,'Permission Admin','access and modify permissions',0,'2020-08-24 10:57:35',1,0),(9,'Sales Manager','access and modify sales',0,'2024-05-03 09:36:33',1,0);
...
CREATE TABLE `ums_role_menu_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=219 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色菜单关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_role_menu_relation` VALUES (96,6,21),(97,6,22),(98,6,23),(99,6,24),(100,6,25),(101,7,21),(102,7,22),(103,7,23),(104,7,24),(105,7,25),(165,2,7),(166,2,8),(167,2,9),(168,2,10),(169,2,11),(176,1,1),(177,1,2),(178,1,3),(179,1,4),(180,1,5),(181,1,6),(182,5,1),(183,5,2),(184,5,3),(185,5,4),(186,5,5),(187,5,6),(188,5,7),(189,5,8),(190,5,9),(191,5,10),(192,5,11),(193,5,12),(194,5,13),(195,5,14),(196,5,16),(197,5,17),(198,5,18),(199,5,19),(200,5,20),(201,5,21),(202,5,22),(203,5,23),(204,5,24),(205,5,25),(206,8,21),(207,8,22),(208,8,23),(209,8,24),(210,8,25),(211,9,12),(212,9,13),(213,9,14),(214,9,16),(215,9,17),(216,9,18),(217,9,19),(218,9,20);
...
CREATE TABLE `ums_role_resource_relation` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=322 DEFAULT CHARSET=utf8mb3 COMMENT='后台角色资源关系表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ums_role_resource_relation` VALUES (178,6,25),(179,6,26),(180,6,27),(181,6,28),(182,6,29),(205,7,25),(206,7,26),(207,7,27),(208,7,28),(209,7,29),(210,7,31),(211,8,25),(212,8,26),(213,8,27),(214,8,28),(215,8,29),(245,2,8),(246,2,9),(247,2,10),(248,2,11),(249,2,12),(277,1,1),(278,1,3),(279,1,4),(280,1,5),(281,1,6),(282,1,23),(283,1,24),(284,1,30),(285,5,1),(286,5,3),(287,5,4),(288,5,5),(289,5,6),(290,5,8),(291,5,9),(292,5,10),(293,5,11),(294,5,12),(295,5,13),(296,5,14),(297,5,15),(298,5,16),(299,5,17),(300,5,18),(301,5,19),(302,5,20),(303,5,21),(304,5,22),(305,5,23),(306,5,24),(307,5,25),(308,5,26),(309,5,27),(310,5,28),(311,5,29),(312,9,13),(313,9,14),(314,9,15),(315,9,16),(316,9,17),(317,9,18),(318,9,19),(319,9,20),(320,9,21),(321,9,22);
...
-- Dump completed on 2024-05-02 18:45:25
