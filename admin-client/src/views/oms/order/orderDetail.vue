<template> 
  <div class="detail-container">
    ...
    <el-card shadow="never" style="margin-top: 15px">
      <div class="operate-container">
        ...
        <div class="operate-button-container" v-show="order.status===0">
          <el-button size="mini" @click="showUpdateReceiverDialog">修改Recipient信息</el-button>
      ...
      <div class="table-layout">
        <el-row>
          ...
          <el-col :span="4" class="table-cell-title">Order Platform</el-col>
      ...
      <div style="margin-top: 20px">
        <svg-icon icon-class="marker" style="color: #606266"></svg-icon>
        <span class="font-small">Recipient信息</span>
      </div>
      <div class="table-layout">
        <el-row>
    ...
    <el-dialog title="修改Recipient信息"
               :visible.sync="receiverDialogVisible"
               width="40%">
      <el-form :model="receiverInfo"
               ref="receiverInfoForm"
               label-width="150px">
        <el-form-item label="Recipient姓名：">
