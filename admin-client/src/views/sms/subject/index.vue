  ...
  <div class="app-container">
      ...
      <div style="margin-top: 15px">
        <el-form :inline="true" :model="listQuery" size="small" label-width="140px">
          ...
          <el-form-item label="推荐状态：">
            <el-select v-model="listQuery.recommendStatus" placeholder="please select" clearable class="input-width">
    ...
    <el-dialog title="选择专题" :visible.sync="selectDialogVisible" width="50%">
      ...
      <el-table :data="dialogData.list"
        ...
        <el-table-column label="Add时间" width="160" align="center">
